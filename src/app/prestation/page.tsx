  ...
  return (
    <main className="min-h-screen bg-black text-white px-8 pb-8 pt-8">
      ...
      <section className="max-w-6xl mx-auto mb-20">
        <h3 className="text-3xl font-bold text-white mb-8 border-l-4 border-green-500 pl-4">
          Publicité
        </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          {/* PACK SILVER */}
          <div className="bg-gray-900 rounded-2xl p-8 border border-gray-800 flex flex-col hover:border-gray-600 transition">
            ...
            <ul className="space-y-4 mb-8 flex-1">
              <li className="flex items-start"><Check className="text-green-500 mr-2 shrink-0" size={18} /> Captation live & mise en scène</li>
              <li className="flex items-start"><Check className="text-green-500 mr-2 shrink-0" size={18} /> Rédactionnel + Cahier des charges</li>
              <li className="flex items-start"><Check className="text-green-500 mr-2 shrink-0" size={18} /> Montage image + son + titrages</li>
              <li className="flex items-start"><Check className="text-green-500 mr-2 shrink-0" size={18} /> Format court &lt; 1 minute (HD)</li>
            </ul>
          ...
          <div className="bg-gray-900 rounded-2xl p-8 border-2 border-yellow-500 relative flex flex-col shadow-[0_0_30px_rgba(234,179,8,0.1)]">

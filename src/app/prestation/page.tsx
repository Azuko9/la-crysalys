...
import { Check, Star } from "lucide-react"; // J'ajoute des icônes pour le style
  ...
  return (
    <main className="min-h-screen bg-background text-foreground px-8 pb-8 pt-8">
      ...
      <div className="max-w-4xl mx-auto text-center bg-card p-4 m-12 rounded-dynamic border border-gray-800">
        <h3 className="text-2xl font-bold text-foreground mb-4">Un projet sur mesure ?</h3>
        <p className="text-foreground/70 mb-8">
          Nous nous adaptons à votre budget et vos exigences spécifiques (Drone FPV, Événementiel, Clip...).
        </p>
        <Link 
          href="/contact" 
          className="bg-primary hover:bg-green-700 text-foreground font-bold py-3 px-8 rounded-dynamic transition transform hover:scale-105 inline-block"
        >
          Demander un Devis
        </Link>
      </div>
      ...
      <section className="max-w-6xl mx-auto mb-20">
        <h3 className="text-3xl font-bold text-foreground mb-8 border-l-4 border-primary pl-4">
          Publicité
        </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-card rounded-dynamic p-8 border border-gray-800 flex flex-col hover:border-gray-600 transition">
            ...
            <p className="text-foreground/70 mb-6 italic">1/2 journée tournage + 2 jours montage</p>
          ...
          <div className="bg-card rounded-dynamic p-8 border-2 border-yellow-500 relative flex flex-col shadow-[0_0_30px_rgba(234,179,8,0.1)]">
            ...
            <p className="text-foreground/70 mb-6 italic">2 demi-journées tournage + 3 jours montage</p> 
      ...
      <section className="max-w-6xl mx-auto mb-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
           ...
           <div className="bg-card rounded-dynamic p-8 border border-gray-800 hover:border-blue-500 transition">
              <div className="text-2xl font-bold mb-2 text-foreground/80">Pack Silver</div>
           ...
           <div className="bg-card rounded-dynamic p-8 border border-gray-800 hover:border-yellow-500 transition">
              ...
              {/*<div className="text-3xl font-bold text-foreground mb-4">2 300 €</div>*/} 
              <ul className="space-y-2 text-foreground/70 mb-6">
